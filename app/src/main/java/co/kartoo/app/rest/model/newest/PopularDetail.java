...
public class PopularDetail implements Serializable{
    ...
    Bank bank;
    Merchant merchant;
    ArrayList<EditorsPick> similarpromotions;
    Boolean isMyCard;
    Boolean isOnline;
    ...
    public ArrayList<EditorsPick> getSimilarpromotions() {
        return similarpromotions;
    }

    public void setSimilarpromotions(ArrayList<EditorsPick> similarpromotions) {
